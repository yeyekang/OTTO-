...
def submission(candidate_type):
    ...
    for t in candidate_type:
        df = pd.read_parquet(f'/home/kangqiman/otto/LB/submission/sub_{t}.pqt')
...
if __name__ == '__main__':
    ...
    submission_final.to_csv(f'/home/kangqimanotto/LB/submission/submission_final.csv', index=False)
